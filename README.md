...
1. ❗️ Opened issue [#3](https://github.com/flipperdevices/flipper-update-server/issues/3) in [flipperdevices/flipper-update-server](https://github.com/flipperdevices/flipper-update-server)
